 ...
 * Topics.
 */
public class RealPublisher implements MessageListener {
    ...
    public static void main(String[] argv) throws Exception {
        RealPublisher p = new RealPublisher();
    ...
    private void run() throws Exception {
        ...
        // request shutdown
        publisher.publish(session.createTextMessage("SHUTDOWN"));
    ...
    private void publish() throws Exception {
        ...
        // request report
        publisher.publish(session.createTextMessage("REPORT"));
    }
